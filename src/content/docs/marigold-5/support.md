...
description: Warranty, technical support, sales, and engineering contact information for Marigold-5.
---

## Warranty

Larkspur Industries provides a manufacturing warranty on Marigold-5. Review the [complete hardware warranty](/docs/warranty/) for coverage, exclusions, the crash replacement program, and the RMA process.

## Contact

- **General support:** [support@larkspurindustries.com](mailto:support@larkspurindustries.com)
- **Sales and quotes:** [sales@larkspurindustries.com](mailto:sales@larkspurindustries.com)
